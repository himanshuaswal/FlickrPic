 ...
 */public class RecentImagesRecyclerViewAdapter extends RecyclerView.Adapter<RecentImagesRecyclerViewAdapter.ImagesViewHolder> {
    private Context mContext;
    private ArrayList<String> mImageURLArrayList;
    private ArrayList<String> mImageIdArrayList;

    public RecentImagesRecyclerViewAdapter(Context mContext, ArrayList<String> mImageURLArrayList, ArrayList<String> mImageIdArrayList) {
    ...
    public ImagesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View rvView = LayoutInflater.from(mContext).inflate(R.layout.activity_rv_recent_image_item, parent, false);
    ...
    public class ImagesViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImagesViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.flickr_recent_thumbnail_iv);
            mTextView = itemView.findViewById(R.id.recent_image_id);
